...
export const HeaderLogo = () => {
  ...
  return (
    <>
      <div className='flex font-mono min-w-fit max-sm:w-screen max-md:w-screen max-sm:justify-center max-md:justify-center text-white border'>
        <h1 className='flex text-3xl max-sm:text-lg max-md:text-2xl max-lg:text-xl font-bold mx-2 max-sm:mx-0 p-3'>
